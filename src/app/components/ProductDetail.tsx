  ...
  export function ProductDetail({ product, onClose }: ProductDetailProps) {
    ...
    const handleContactSeller = () => {
      ...
      // Используем уже готовую переменную sellerUsername, 
      // которую ты вычисляешь выше через getValidSellerUsername()
      if (hasValidSeller && sellerUsername) {
        // Ссылка будет https://t.me/jalabmoney (без лишних собачек)
        ...
        // Если юзернейм пустой или не прошел валидацию
        if (tg && tg.showPopup) {
          tg.showPopup({ 
            title: 'Упс!',
              ...
              <div className="pt-6 space-y-3">
                ...
                >
                  {isSent ? (
                    <>
                      <span>✅</span>
                      Информация отправлена в чат бота
                    </>
                  ) : (
                    <>
                      <span>🚕</span>
